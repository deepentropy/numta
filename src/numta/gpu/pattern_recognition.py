"""
GPU CUDA kernels for candlestick pattern recognition (batch processing).
...
@cuda.jit
def _cdlmarubozu_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    """
    ...
    for i in range(n):
        ...
        body = abs(close_2d[tid, i] - open_2d[tid, i])
        total_range = high_2d[tid, i] - low_2d[tid, i]
        ...
        if body_ratio >= 0.95:
            ...
            if close_2d[tid, i] > open_2d[tid, i]:
                # Bullish Marubozu: white/green candle
                output_2d[tid, i] = 100
            elif close_2d[tid, i] < open_2d[tid, i]:
...
@cuda.jit
def _cdlmatchinglow_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    """
    ...
    for i in range(max(0, n - lookback), n):
        avg_range += high_2d[tid, i] - low_2d[tid, i]
    if lookback > 0:
        avg_range /= lookback
    ...
    for i in range(1, n):
        ...
        is_black_1 = close_2d[tid, i-1] < open_2d[tid, i-1]
        is_black_2 = close_2d[tid, i] < open_2d[tid, i]

        if is_black_1 and is_black_2:
            # Check if closes match within tolerance
            close_diff = abs(close_2d[tid, i] - close_2d[tid, i-1])
...
@cuda.jit
def _cdlmathold_batch_cuda(open_2d, high_2d, low_2d, close_2d, penetration, output_2d):
    """
    ...
    for i in range(4, n):
        ...
        body_1 = close_2d[tid, i-4] - open_2d[tid, i-4]
        is_white_1 = close_2d[tid, i-4] > open_2d[tid, i-4]
        ...
        for j in range(max(0, i-15), max(0, i-5)):
            avg_body += abs(close_2d[tid, j] - open_2d[tid, j])
            count += 1
        if count > 0:
            avg_body /= count
        else:
        ...
        is_black_2 = close_2d[tid, i-3] < open_2d[tid, i-3]
        body_2 = abs(close_2d[tid, i-3] - open_2d[tid, i-3])
        has_gap_up = open_2d[tid, i-3] > close_2d[tid, i-4]
        ...
        body_3 = abs(close_2d[tid, i-2] - open_2d[tid, i-2])
        body_4 = abs(close_2d[tid, i-1] - open_2d[tid, i-1])
        ...
        falling_pattern = close_2d[tid, i-2] < open_2d[tid, i-3] and high_2d[tid, i-1] < high_2d[tid, i-2]
        ...
        penetration_level = close_2d[tid, i-4] - (body_1 * penetration)
        within_body = (low_2d[tid, i-3] >= penetration_level and
                      low_2d[tid, i-2] >= penetration_level and
                      low_2d[tid, i-1] >= penetration_level)
        ...
        is_white_5 = close_2d[tid, i] > open_2d[tid, i]
        max_high_234 = max(high_2d[tid, i-3], max(high_2d[tid, i-2], high_2d[tid, i-1]))
        closes_above = close_2d[tid, i] > max_high_234
        opens_above = open_2d[tid, i] > close_2d[tid, i-1]
...
@cuda.jit
def _cdlmorningdojistar_batch_cuda(open_2d, high_2d, low_2d, close_2d, penetration, output_2d):
    """
    ...
    for i in range(2, n):
        ...
        if count > 0:
            ...
            avg_body = abs(close_2d[tid, i-2] - open_2d[tid, i-2])

        # First candle: long black
        body_1 = close_2d[tid, i-2] - open_2d[tid, i-2]
        is_black_1 = close_2d[tid, i-2] < open_2d[tid, i-2]
        ...
        body_2 = abs(close_2d[tid, i-1] - open_2d[tid, i-1])
        is_doji = body_2 <= avg_body * 0.1
        has_gap_down = open_2d[tid, i-1] < close_2d[tid, i-2]
        ...
        is_white_3 = close_2d[tid, i] > open_2d[tid, i]
        body_3 = abs(close_2d[tid, i] - open_2d[tid, i])
        is_significant_3 = body_3 > avg_body * 0.3
        penetrates = close_2d[tid, i] > close_2d[tid, i-2] + abs(body_1) * penetration
...
@cuda.jit
def _cdlmorningstar_batch_cuda(open_2d, high_2d, low_2d, close_2d, penetration, output_2d):
    """
    ...
    for i in range(2, n):
        ...
        has_gap_down = max(open_2d[tid, i-1], close_2d[tid, i-1]) < close_2d[tid, i-2]
...
@cuda.jit
def _cdlonneck_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    """
    ...
    for i in range(1, n):
        ...
        if count > 0:
            ...
            avg_body = abs(close_2d[tid, i-1] - open_2d[tid, i-1])

        # Calculate average range for tolerance
        avg_range = 0.0
        for j in range(max(0, i-10), i):
            avg_range += high_2d[tid, j] - low_2d[tid, j]
        if count > 0:
            avg_range /= min(10, i)
        else:
            avg_range = high_2d[tid, i-1] - low_2d[tid, i-1]

        tolerance = avg_range * 0.002  # 0.2% tolerance

        # First candle: long black
        is_black_1 = close_2d[tid, i-1] < open_2d[tid, i-1]
        body_1 = abs(close_2d[tid, i-1] - open_2d[tid, i-1])
        ...
        is_white_2 = close_2d[tid, i] > open_2d[tid, i]
        opens_below = open_2d[tid, i] < low_2d[tid, i-1]

        # Close matches prior low (within tolerance)
        close_matches_low = (close_2d[tid, i] >= low_2d[tid, i-1] - tolerance and
                            close_2d[tid, i] <= low_2d[tid, i-1] + tolerance)

        if is_white_2 and opens_below and close_matches_low:
            output_2d[tid, i] = -100  # Bearish continuation
        else:
            output_2d[tid, i] = 0


@cuda.jit
def _cdlpiercing_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    """
    ...
    for i in range(1, n):
        ...
        is_white_2 = close_2d[tid, i] > open_2d[tid, i]
        body_2 = abs(close_2d[tid, i] - open_2d[tid, i])
        ...
        # Gap down opening
        opens_below_low = open_2d[tid, i] < low_2d[tid, i-1]

        # Close above midpoint of prior body
        midpoint = close_2d[tid, i-1] + body_1 * 0.5
        closes_above_mid = close_2d[tid, i] > midpoint

        # But not above prior open (distinguishes from engulfing)
        closes_below_open = close_2d[tid, i] < open_2d[tid, i-1]

        if opens_below_low and closes_above_mid and closes_below_open:
            output_2d[tid, i] = 100  # Bullish reversal
        else:
            output_2d[tid, i] = 0


@cuda.jit
def _cdlrickshawman_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(n):
        ...
        for j in range(max(0, i-10), i):
            avg_body += abs(close_2d[tid, j] - open_2d[tid, j])
            count += 1
        avg_body = avg_body / count if count > 0 else abs(close_2d[tid, i] - open_2d[tid, i])

        body = abs(close_2d[tid, i] - open_2d[tid, i])
        upper_shadow = high_2d[tid, i] - max(open_2d[tid, i], close_2d[tid, i])
        lower_shadow = min(open_2d[tid, i], close_2d[tid, i]) - low_2d[tid, i]
        total_range = high_2d[tid, i] - low_2d[tid, i]
        ...
        # Body near midpoint
        midpoint = low_2d[tid, i] + total_range / 2
        tolerance = total_range * 0.15
        body_near_mid = (min(open_2d[tid, i], close_2d[tid, i]) <= midpoint + tolerance and
                        max(open_2d[tid, i], close_2d[tid, i]) >= midpoint - tolerance)

        if is_doji and has_long_shadows and body_near_mid:
            output_2d[tid, i] = 100  # Neutral/indecision
        else:
            output_2d[tid, i] = 0


@cuda.jit
def _cdlrisefall3methods_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(4, n):
        ...
        body_2, body_3, body_4 = close_2d[tid, i-3] - open_2d[tid, i-3], close_2d[tid, i-2] - open_2d[tid, i-2], close_2d[tid, i-1] - open_2d[tid, i-1]
        all_small = (abs(body_2) < avg_body * 0.5 and
                    abs(body_3) < avg_body * 0.5 and
                    abs(body_4) < avg_body * 0.5)

        # 5th candle: long, same color as 1st
        body_5 = close_2d[tid, i] - open_2d[tid, i]
        ...
        if (body_1 > 0 and is_long_1 and all_small and
            ...
            high_2d[tid, i-3] < high_2d[tid, i-4] and high_2d[tid, i-2] < high_2d[tid, i-4] and high_2d[tid, i-1] < high_2d[tid, i-4] and
            low_2d[tid, i-3] > low_2d[tid, i-4] and low_2d[tid, i-2] > low_2d[tid, i-4] and low_2d[tid, i-1] > low_2d[tid, i-4] and
            is_long_5 and body_5 > 0 and close_2d[tid, i] > close_2d[tid, i-4]):
            output_2d[tid, i] = 100
...
@cuda.jit
def _cdlseparatinglines_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(1, n):
        ...
        # Opposite colors
        is_opposite = (close_2d[tid, i-1] > open_2d[tid, i-1] and close_2d[tid, i] < open_2d[tid, i]) or (close_2d[tid, i-1] < open_2d[tid, i-1] and close_2d[tid, i] > open_2d[tid, i])

        # Matching opens
        open_match = abs(open_2d[tid, i] - open_2d[tid, i-1]) <= avg_range * 0.002

        # Long body on second candle
        is_long_2 = abs(close_2d[tid, i] - open_2d[tid, i]) > avg_body * 1.2

        upper_shadow = high_2d[tid, i] - max(open_2d[tid, i], close_2d[tid, i])
        lower_shadow = min(open_2d[tid, i], close_2d[tid, i]) - low_2d[tid, i]

        # Bullish: white candle with small lower shadow
        if is_opposite and open_match and is_long_2 and close_2d[tid, i] > open_2d[tid, i] and lower_shadow < avg_body * 0.1:
            output_2d[tid, i] = 100
        # Bearish: black candle with small upper shadow
        elif is_opposite and open_match and is_long_2 and close_2d[tid, i] < open_2d[tid, i] and upper_shadow < avg_body * 0.1:
            output_2d[tid, i] = -100
        else:
            output_2d[tid, i] = 0
...
@cuda.jit
def _cdlshootingstar_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(1, n):
        ...
        has_gap_up = min(open_2d[tid, i], close_2d[tid, i]) > max(open_2d[tid, i-1], close_2d[tid, i-1])

        if is_small_body and has_long_upper and has_short_lower and has_gap_up:
            output_2d[tid, i] = -100  # Bearish
        else:
            output_2d[tid, i] = 0


@cuda.jit
def _cdlshortline_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(n):
        ...
        for j in range(max(0, i-10), i):
            avg_body += abs(close_2d[tid, j] - open_2d[tid, j])
            upper_shadow = high_2d[tid, j] - max(open_2d[tid, j], close_2d[tid, j])
            lower_shadow = min(open_2d[tid, j], close_2d[tid, j]) - low_2d[tid, j]
        ...
        if is_short_body and is_short_upper and is_short_lower:
            ...
            if close_2d[tid, i] >= open_2d[tid, i]:
                output_2d[tid, i] = 100  # White/bullish
            else:
                output_2d[tid, i] = -100  # Black/bearish
        else:
            output_2d[tid, i] = 0


@cuda.jit
def _cdlspinningtop_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(n):
        ...
        if is_small_body and has_long_shadows:
            if close_2d[tid, i] >= open_2d[tid, i]:
                output_2d[tid, i] = 100  # White
            else:
                output_2d[tid, i] = -100  # Black
        else:
            output_2d[tid, i] = 0


@cuda.jit
def _cdlstalledpattern_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(2, n):
        ...
        body_1 = close_2d[tid, i-2] - open_2d[tid, i-2]
        body_2 = close_2d[tid, i-1] - open_2d[tid, i-1]
        body_3 = close_2d[tid, i] - open_2d[tid, i]

        all_white = body_1 > 0 and body_2 > 0 and body_3 > 0
        higher_closes = close_2d[tid, i] > close_2d[tid, i-1] > close_2d[tid, i-2]
        ...
        upper_shadow_2 = high_2d[tid, i-1] - max(open_2d[tid, i-1], close_2d[tid, i-1])
        short_upper_2 = upper_shadow_2 < avg_body * 0.1

        # Second opens within first body
        opens_near_1 = open_2d[tid, i-1] > open_2d[tid, i-2] and open_2d[tid, i-1] <= close_2d[tid, i-2] + avg_body * 0.2

        # Third candle: small body
        is_small_3 = abs(body_3) < avg_body * 1.0

        # Third opens near top of second (riding on shoulder)
        rides_shoulder = open_2d[tid, i] >= close_2d[tid, i-1] - abs(body_3) - avg_body * 0.2
        ...
        if (all_white and higher_closes and is_long_1 and is_long_2 and
            ...
            output_2d[tid, i] = -100  # Bearish signal (momentum weakening)
        else:
            output_2d[tid, i] = 0


@cuda.jit
def _cdlsticksandwich_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(2, n):
        ...
        gap_up = low_2d[tid, i-1] > close_2d[tid, i-2]

        # First and third closes match (within tolerance)
        tolerance = avg_body * 0.05
        closes_match = abs(close_2d[tid, i] - close_2d[tid, i-2]) <= tolerance
...
@cuda.jit
def _cdltakuri_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
...
@cuda.jit
def _cdltasukigap_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(2, n):
        ...
        # Upside Tasuki Gap
        gap_up = low_2d[tid, i-1] > high_2d[tid, i-2]
        is_white_1 = body_1 > 0
        is_white_2 = body_2 > 0
        is_black_3 = body_3 < 0
        opens_in_body_2 = open_2d[tid, i] < close_2d[tid, i-1] and open_2d[tid, i] > open_2d[tid, i-1]
        closes_above_gap = close_2d[tid, i] > high_2d[tid, i-2]

        if (gap_up and is_white_1 and is_white_2 and is_black_3 and
            bodies_similar and opens_in_body_2 and closes_above_gap):
            output_2d[tid, i] = 100  # Bullish continuation
            continue

        # Downside Tasuki Gap
        gap_down = high_2d[tid, i-1] < low_2d[tid, i-2]
        is_black_1 = body_1 < 0
        is_black_2 = body_2 < 0
        is_white_3 = body_3 > 0
        opens_in_body_2_down = open_2d[tid, i] > close_2d[tid, i-1] and open_2d[tid, i] < open_2d[tid, i-1]
        closes_below_gap = close_2d[tid, i] < low_2d[tid, i-2]
...
@cuda.jit
def _cdlthrusting_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(1, n):
        ...
        body_1 = close_2d[tid, i-1] - open_2d[tid, i-1]
        body_2 = close_2d[tid, i] - open_2d[tid, i]
        ...
        midpoint = close_2d[tid, i-1] + abs(body_1) * 0.5
        closes_in_body = close_2d[tid, i] > close_2d[tid, i-1]
        closes_below_mid = close_2d[tid, i] <= midpoint
...
@cuda.jit
def _cdltristar_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(2, n):
        ...
        body_1 = abs(close_2d[tid, i-2] - open_2d[tid, i-2])
        body_2 = abs(close_2d[tid, i-1] - open_2d[tid, i-1])
        body_3 = abs(close_2d[tid, i] - open_2d[tid, i])
        ...
        gap_up = low_2d[tid, i-1] > high_2d[tid, i-2]
        third_not_higher = high_2d[tid, i] <= high_2d[tid, i-1]
        ...
        gap_down = high_2d[tid, i-1] < low_2d[tid, i-2]
        third_not_lower = low_2d[tid, i] >= low_2d[tid, i-1]
...
@cuda.jit
def _cdlunique3river_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(2, n):
        ...
        is_black_2 = body_2 < 0
        close_higher = close_2d[tid, i-1] > close_2d[tid, i-2]
        open_within = open_2d[tid, i-1] <= open_2d[tid, i-2]
        low_below = low_2d[tid, i-1] < low_2d[tid, i-2]

        # 3rd: small white (open > 2nd low)
        is_white_3 = body_3 > 0
        is_small_3 = abs(body_3) < avg_body * 1.0
        opens_above = open_2d[tid, i] > low_2d[tid, i-1]
        ...
        if (is_black_1 and is_long_1 and is_black_2 and close_higher and
            ...
            output_2d[tid, i] = 100  # Bullish
        else:
            output_2d[tid, i] = 0


@cuda.jit
def _cdlupsidegap2crows_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(2, n):
        ...
        is_black_3 = body_3 < 0
        opens_higher = open_2d[tid, i] > open_2d[tid, i-1]
        closes_lower = close_2d[tid, i] < close_2d[tid, i-1]
        closes_above_1st = close_2d[tid, i] > close_2d[tid, i-2]
...
@cuda.jit
def _cdlxsidegap3methods_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(2, n):
        ...
        gap_up = low_2d[tid, i-1] > high_2d[tid, i-2]
        opens_in_body_2 = open_2d[tid, i] < close_2d[tid, i-1] and open_2d[tid, i] > open_2d[tid, i-1]
        closes_in_body_1 = close_2d[tid, i] < close_2d[tid, i-2] and close_2d[tid, i] > open_2d[tid, i-2]
        ...
        gap_down = high_2d[tid, i-1] < low_2d[tid, i-2]
        opens_in_body_2_down = open_2d[tid, i] > close_2d[tid, i-1] and open_2d[tid, i] < open_2d[tid, i-1]
        closes_in_body_1_down = close_2d[tid, i] > close_2d[tid, i-2] and close_2d[tid, i] < open_2d[tid, i-2]
...
@cuda.jit
def _cdl2crows_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    """
    ...
    for i in range(2, n):
        ...
        body_2 = close_2d[tid, i-1] - open_2d[tid, i-1]
        is_black_2 = body_2 < 0
        gaps_up = open_2d[tid, i-1] > close_2d[tid, i-2]
        closes_in_body_1 = close_2d[tid, i-1] < close_2d[tid, i-2] and close_2d[tid, i-1] > open_2d[tid, i-2]

        # Third candle: Black candle
        body_3 = close_2d[tid, i] - open_2d[tid, i]
        is_black_3 = body_3 < 0
        opens_above_body_2 = open_2d[tid, i] > close_2d[tid, i-1] and open_2d[tid, i] < open_2d[tid, i-1]
        closes_lower = close_2d[tid, i] < close_2d[tid, i-1]
...
@cuda.jit
def _cdl3blackcrows_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    """
    ...
    for i in range(2, n):
        ...
        opens_in_body_2 = open_2d[tid, i-1] < open_2d[tid, i-2] and open_2d[tid, i-1] > close_2d[tid, i-2]
        opens_in_body_3 = open_2d[tid, i] < open_2d[tid, i-1] and open_2d[tid, i] > close_2d[tid, i-1]

        # Progressive lower closes
        lower_closes = close_2d[tid, i-1] < close_2d[tid, i-2] and close_2d[tid, i] < close_2d[tid, i-1]

        # Small upper shadows (characteristic of the pattern)
        upper_shadow_1 = high_2d[tid, i-2] - open_2d[tid, i-2]
        upper_shadow_2 = high_2d[tid, i-1] - open_2d[tid, i-1]
        upper_shadow_3 = high_2d[tid, i] - open_2d[tid, i]
...
@cuda.jit
def _cdl3inside_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    """
    ...
    for i in range(2, n):
        ...
        is_white_2 = body_2 > 0
        inside_body_1 = (open_2d[tid, i-1] < open_2d[tid, i-2] and open_2d[tid, i-1] > close_2d[tid, i-2] and
                        close_2d[tid, i-1] > close_2d[tid, i-2] and close_2d[tid, i-1] < open_2d[tid, i-2])
        is_white_3 = body_3 > 0
        closes_above_high_1 = close_2d[tid, i] > high_2d[tid, i-2]
        ...
        is_black_2 = body_2 < 0
        inside_body_1_bear = (open_2d[tid, i-1] > close_2d[tid, i-2] and open_2d[tid, i-1] < open_2d[tid, i-2] and
                             close_2d[tid, i-1] < close_2d[tid, i-2] and close_2d[tid, i-1] > open_2d[tid, i-2])
        is_black_3 = body_3 < 0
        closes_below_low_1 = close_2d[tid, i] < low_2d[tid, i-2]
...
@cuda.jit
def _cdl3outside_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    """
    ...
    for i in range(2, n):
        ...
        engulfs_bullish = (open_2d[tid, i-1] < close_2d[tid, i-2] and close_2d[tid, i-1] > open_2d[tid, i-2])
        is_white_3 = body_3 > 0
        closes_higher = close_2d[tid, i] > close_2d[tid, i-1]
        ...
        engulfs_bearish = (open_2d[tid, i-1] > close_2d[tid, i-2] and close_2d[tid, i-1] < open_2d[tid, i-2])
        is_black_3 = body_3 < 0
        closes_lower = close_2d[tid, i] < close_2d[tid, i-1]
...
@cuda.jit
def _cdl3starsinsouth_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    """
    ...
    for i in range(2, n):
        ...
        lower_shadow_1 = min(open_2d[tid, i-2], close_2d[tid, i-2]) - low_2d[tid, i-2]
        ...
        within_range_2 = (open_2d[tid, i-1] < open_2d[tid, i-2] and close_2d[tid, i-1] > close_2d[tid, i-2])

        # Third candle: Short marubozu within second candle's range
        is_short_3 = abs(body_3) < abs(body_2)
        lower_shadow_3 = close_2d[tid, i] - low_2d[tid, i]
        is_marubozu_3 = lower_shadow_3 < abs(body_3) * 0.2
        within_range_3 = (open_2d[tid, i] < open_2d[tid, i-1] and close_2d[tid, i] > close_2d[tid, i-1])
...
@cuda.jit
def _cdl3whitesoldiers_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    """
    ...
    for i in range(2, n):
        ...
        opens_in_body_2 = open_2d[tid, i-1] > close_2d[tid, i-2] and open_2d[tid, i-1] < open_2d[tid, i-2]
        opens_in_body_3 = open_2d[tid, i] > close_2d[tid, i-1] and open_2d[tid, i] < open_2d[tid, i-1]

        # Progressive higher closes
        higher_closes = close_2d[tid, i-1] > close_2d[tid, i-2] and close_2d[tid, i] > close_2d[tid, i-1]

        # Small lower shadows (characteristic of the pattern)
        lower_shadow_1 = open_2d[tid, i-2] - low_2d[tid, i-2]
        lower_shadow_2 = open_2d[tid, i-1] - low_2d[tid, i-1]
        lower_shadow_3 = open_2d[tid, i] - low_2d[tid, i]
...
@cuda.jit
def _cdlabandonedbaby_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    """
    ...
    for i in range(2, n):
        ...
        gap_down = high_2d[tid, i-1] < low_2d[tid, i-2]
        is_white_3 = body_3 > 0
        gap_up = low_2d[tid, i] > high_2d[tid, i-1]
        ...
        is_white_1 = body_1 > 0
        gap_up_2 = low_2d[tid, i-1] > high_2d[tid, i-2]
        is_black_3 = body_3 < 0
        gap_down_3 = high_2d[tid, i] < low_2d[tid, i-1]
...
@cuda.jit
def _cdladvanceblock_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    """
    ...
    for i in range(2, n):
        ...
        upper_shadow_1 = high_2d[tid, i-2] - close_2d[tid, i-2]
        upper_shadow_2 = high_2d[tid, i-1] - close_2d[tid, i-1]
        upper_shadow_3 = high_2d[tid, i] - close_2d[tid, i]
...
@cuda.jit
def _cdlbelthold_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    """
    ...
    for i in range(n):
        ...
        body = close_2d[tid, i] - open_2d[tid, i]
        total_range = high_2d[tid, i] - low_2d[tid, i]
        ...
        if body > 0:
            lower_shadow = open_2d[tid, i] - low_2d[tid, i]
            upper_shadow = high_2d[tid, i] - close_2d[tid, i]
        ...
        # Bearish Belt Hold: Black candle opening on high
            ...
            lower_shadow = min(open_2d[tid, i], close_2d[tid, i]) - low_2d[tid, i]
            upper_shadow = high_2d[tid, i] - open_2d[tid, i]
...
@cuda.jit
def _cdlbreakaway_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    """
    ...
    for i in range(4, n):
        ...
        body_1 = close_2d[tid, i-4] - open_2d[tid, i-4]
        body_2 = close_2d[tid, i-3] - open_2d[tid, i-3]
        body_5 = close_2d[tid, i] - open_2d[tid, i]

        # Bullish Breakaway
        is_black_1 = body_1 < 0 and abs(body_1) > avg_body * 0.7
        gap_down = high_2d[tid, i-3] < low_2d[tid, i-4]
        is_white_5 = body_5 > 0 and abs(body_5) > avg_body * 0.7

        # Fifth candle closes in the gap created by first two candles
        closes_in_gap = close_2d[tid, i] > close_2d[tid, i-4] and close_2d[tid, i] < open_2d[tid, i-4]

        # Middle candles (2,3,4) should continue downward
        continuing_down = close_2d[tid, i-2] <= close_2d[tid, i-3] or close_2d[tid, i-1] <= close_2d[tid, i-2]
        ...
        gap_up = low_2d[tid, i-3] > high_2d[tid, i-4]
        is_black_5 = body_5 < 0 and abs(body_5) > avg_body * 0.7

        # Fifth candle closes in the gap created by first two candles
        closes_in_gap_bear = close_2d[tid, i] < close_2d[tid, i-4] and close_2d[tid, i] > open_2d[tid, i-4]

        # Middle candles (2,3,4) should continue upward
        continuing_up = close_2d[tid, i-2] >= close_2d[tid, i-3] or close_2d[tid, i-1] >= close_2d[tid, i-2]
...
@cuda.jit
def _cdlclosingmarubozu_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(n):
        ...
        range_ = high_2d[tid, i] - low_2d[tid, i]
        if range_ < 1e-10:
            continue
        ...
        # Bearish Closing Marubozu: black candle, closes at low, has upper shadow
            ...
            upper_shadow = high_2d[tid, i] - open_2d[tid, i]
            lower_shadow = close_2d[tid, i] - low_2d[tid, i]
...
@cuda.jit
def _cdlconcealbabyswall_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(10, n):
        ...
        for j in range(i - 10, i):
            total_body += abs(close_2d[tid, j] - open_2d[tid, j])
        ...
        # Get the 4 candles
        body_1 = close_2d[tid, i-3] - open_2d[tid, i-3]  # First candle
        body_2 = close_2d[tid, i-2] - open_2d[tid, i-2]  # Second candle
        body_3 = close_2d[tid, i-1] - open_2d[tid, i-1]  # Third candle
        body_4 = close_2d[tid, i] - open_2d[tid, i]      # Fourth candle

        # First candle: Black Marubozu
        is_black_1 = body_1 < 0 and abs(body_1) > avg_body * 0.7
        upper_shadow_1 = high_2d[tid, i-3] - open_2d[tid, i-3]
        lower_shadow_1 = close_2d[tid, i-3] - low_2d[tid, i-3]
        ...
        upper_shadow_2 = high_2d[tid, i-2] - open_2d[tid, i-2]
        lower_shadow_2 = close_2d[tid, i-2] - low_2d[tid, i-2]
        ...
        engulfs_third = open_2d[tid, i] > open_2d[tid, i-1] and close_2d[tid, i] < close_2d[tid, i-1]
        ...
        if (is_black_1 and is_marubozu_1 and
            ...
            output_2d[tid, i] = 100  # Bullish reversal (selling exhaustion)
        else:
            output_2d[tid, i] = 0


@cuda.jit
def _cdlcounterattack_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(10, n):
        ...
        opens_lower = open_2d[tid, i] < low_2d[tid, i-1]
        closes_match = abs(close_2d[tid, i] - close_2d[tid, i-1]) < avg_body * 0.1
        ...
        opens_higher = open_2d[tid, i] > high_2d[tid, i-1]
...
@cuda.jit
def _cdldarkcloudcover_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(10, n):
        ...
        opens_above = open_2d[tid, i] > high_2d[tid, i-1]

        # Closes well into previous candle's body (at least 50% penetration)
        midpoint = open_2d[tid, i-1] + body_1 * 0.5
        penetrates_body = close_2d[tid, i] < midpoint and close_2d[tid, i] > open_2d[tid, i-1]
...
@cuda.jit
def _cdldoji_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
...
@cuda.jit
def _cdldojistar_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(10, n):
        ...
        body_1 = close_2d[tid, i-1] - open_2d[tid, i-1]
        body_2 = abs(close_2d[tid, i] - open_2d[tid, i])
        range_2 = high_2d[tid, i] - low_2d[tid, i]
        ...
        is_black_1 = body_1 < 0 and abs(body_1) > avg_body * 0.7
        gap_down = low_2d[tid, i] > high_2d[tid, i-1]
        ...
        is_white_1 = body_1 > 0 and abs(body_1) > avg_body * 0.7
        gap_up = high_2d[tid, i] < low_2d[tid, i-1]
...
@cuda.jit
def _cdldragonflydoji_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
...
@cuda.jit
def _cdlengulfing_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(10, n):
        ...
        engulfs_bull = open_2d[tid, i] <= close_2d[tid, i-1] and close_2d[tid, i] >= open_2d[tid, i-1]
        ...
        engulfs_bear = open_2d[tid, i] >= close_2d[tid, i-1] and close_2d[tid, i] <= open_2d[tid, i-1]
...
@cuda.jit
def _cdleveningdojistar_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(10, n):
        ...
        body_2 = abs(close_2d[tid, i-1] - open_2d[tid, i-1])
        body_3 = close_2d[tid, i] - open_2d[tid, i]
        range_2 = high_2d[tid, i-1] - low_2d[tid, i-1]
        ...
        closes_into_body = close_2d[tid, i] < (open_2d[tid, i-2] + body_1 * 0.5)
...
@cuda.jit
def _cdleveningstar_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
...
@cuda.jit
def _cdlgapsidesidewhite_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(10, n):
        ...
        similar_open = abs(open_2d[tid, i] - open_2d[tid, i-1]) < avg_body * 0.2
...
@cuda.jit
def _cdlgravestonedoji_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
...
@cuda.jit
def _cdlhammer_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
...
@cuda.jit
def _cdlhangingman_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
...
@cuda.jit
def _cdlharami_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(10, n):
        ...
        contained_bull = (open_2d[tid, i] < open_2d[tid, i-1] and open_2d[tid, i] > close_2d[tid, i-1] and
                         close_2d[tid, i] < open_2d[tid, i-1] and close_2d[tid, i] > close_2d[tid, i-1])
        ...
        is_black_2 = body_2 < 0
        # Second candle completely within first body
        contained_bear = (open_2d[tid, i] > open_2d[tid, i-1] and open_2d[tid, i] < close_2d[tid, i-1] and
                         close_2d[tid, i] > open_2d[tid, i-1] and close_2d[tid, i] < close_2d[tid, i-1])
...
@cuda.jit
def _cdlharamicross_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(10, n):
        ...
        doji_min = min(open_2d[tid, i], close_2d[tid, i])
        doji_max = max(open_2d[tid, i], close_2d[tid, i])
        contained_bull = doji_min > close_2d[tid, i-1] and doji_max < open_2d[tid, i-1]
        ...
        is_white_1 = body_1 > 0 and abs(body_1) > avg_body * 0.7
        contained_bear = doji_min > open_2d[tid, i-1] and doji_max < close_2d[tid, i-1]
...
@cuda.jit
def _cdlhighwave_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
...
@cuda.jit
def _cdlhikkake_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(2, n):
        ...
        is_inside = (high_2d[tid, i-1] < high_2d[tid, i-2] and low_2d[tid, i-1] > low_2d[tid, i-2])
        ...
        if low_2d[tid, i] < low_2d[tid, i-1]:
            output_2d[tid, i] = 100
        # Bearish Hikkake: Day 3 breaks above Day 2 high
        elif high_2d[tid, i] > high_2d[tid, i-1]:
            output_2d[tid, i] = -100
        else:
            output_2d[tid, i] = 0
...
@cuda.jit
def _cdlhikkakemod_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(2, n):
        ...
        if confirmed:
            output_2d[tid, i] = signal
        else:
            output_2d[tid, i] = 0


@cuda.jit
def _cdlhomingpigeon_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(10, n):
        ...
        # First candle (i-1)
        body1 = close_2d[tid, i-1] - open_2d[tid, i-1]
        # Second candle (i)
        body2 = close_2d[tid, i] - open_2d[tid, i]
        ...
        body1_top = open_2d[tid, i-1]
        body1_bottom = close_2d[tid, i-1]
        body2_top = open_2d[tid, i]
        body2_bottom = close_2d[tid, i]
...
@cuda.jit
def _cdlidentical3crows_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(11, n):
        ...
        body1 = close_2d[tid, i-2] - open_2d[tid, i-2]
        body2 = close_2d[tid, i-1] - open_2d[tid, i-1]
        body3 = close_2d[tid, i] - open_2d[tid, i]
        ...
        # Each opens within prior body
        opens_in_body = (close_2d[tid, i-2] < open_2d[tid, i-1] < open_2d[tid, i-2] and
                        close_2d[tid, i-1] < open_2d[tid, i] < open_2d[tid, i-1])
        ...
        closes_lower = close_2d[tid, i-1] < close_2d[tid, i-2] and close_2d[tid, i] < close_2d[tid, i-1]
        ...
        avg_close = (close_2d[tid, i-2] + close_2d[tid, i-1] + close_2d[tid, i]) / 3.0
        tolerance = abs(avg_close) * 0.005

        close_diff_1_2 = abs(close_2d[tid, i-1] - close_2d[tid, i-2])
        close_diff_2_3 = abs(close_2d[tid, i] - close_2d[tid, i-1])
...
@cuda.jit
def _cdlinneck_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(10, n):
        ...
        if open_2d[tid, i] >= low_2d[tid, i-1]:
            output_2d[tid, i] = 0
            continue

        # Second candle closes at/near first candle's low (within 1% of range)
        range1 = high_2d[tid, i-1] - low_2d[tid, i-1]
        tolerance = range1 * 0.01 if range1 > 0 else 1e-10

        closes_at_neck = abs(close_2d[tid, i] - low_2d[tid, i-1]) < tolerance
...
@cuda.jit
def _cdlinvertedhammer_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
...
@cuda.jit
def _cdlkicking_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(10, n):
        ...
        body1 = abs(close_2d[tid, i-1] - open_2d[tid, i-1])
        body2 = abs(close_2d[tid, i] - open_2d[tid, i])
        range1 = high_2d[tid, i-1] - low_2d[tid, i-1]
        range2 = high_2d[tid, i] - low_2d[tid, i]
        ...
        if close_2d[tid, i-1] < open_2d[tid, i-1] and close_2d[tid, i] > open_2d[tid, i]:
            # Gap up (second opens above first close)
            if open_2d[tid, i] > close_2d[tid, i-1]:
                output_2d[tid, i] = 100  # Bullish
            else:
                output_2d[tid, i] = 0
        # First candle white, second black (bearish)
        elif close_2d[tid, i-1] > open_2d[tid, i-1] and close_2d[tid, i] < open_2d[tid, i]:
...
@cuda.jit
def _cdlkickingbylength_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
...
@cuda.jit
def _cdlladderbottom_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(11, n):
        ...
        body1 = close_2d[tid, i-4] - open_2d[tid, i-4]
        body2 = close_2d[tid, i-3] - open_2d[tid, i-3]
        body3 = close_2d[tid, i-2] - open_2d[tid, i-2]
        body4 = close_2d[tid, i-1] - open_2d[tid, i-1]
        body5 = close_2d[tid, i] - open_2d[tid, i]
        ...
        if not (close_2d[tid, i-3] < close_2d[tid, i-4] and close_2d[tid, i-2] < close_2d[tid, i-3]):
            output_2d[tid, i] = 0
            continue

        # Fourth candle opens lower (gap down or just lower)
        if open_2d[tid, i-1] >= open_2d[tid, i-2]:
            output_2d[tid, i] = 0
            continue

        # Fifth candle (white) closes above fourth's open
        if close_2d[tid, i] > open_2d[tid, i-1]:
            output_2d[tid, i] = 100  # Bullish reversal
        else:
            output_2d[tid, i] = 0
...
@cuda.jit
def _cdllongleggeddoji_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(10, n):
        ...
        if both_very_long:
            output_2d[tid, i] = 100  # Signal of extreme indecision
        else:
            output_2d[tid, i] = 0


@cuda.jit
def _cdllongline_batch_cuda(open_2d, high_2d, low_2d, close_2d, output_2d):
    ...
    for i in range(10, n):
        ...
        if is_long:
            if body > 0:
                output_2d[tid, i] = 100  # White (bullish) long line
            else:
                output_2d[tid, i] = -100  # Black (bearish) long line
        else:
            output_2d[tid, i] = 0
